...
export default function WarpField({ audioData }) {
	...
	const {
		...
		"WarpField",
		{
			count: { value: 4000, min: 500, max: 20000, step: 100 },
			radius: { value: 14, min: 2, max: 40, step: 0.5 },
			tunnelDepth: { value: 60, min: 10, max: 200, step: 1 },
			speed: { value: 18, min: 0, max: 80, step: 0.5 },
			streakLength: { value: 1.6, min: 0, max: 6, step: 0.1 },
			nearSize: { value: 4, min: 0.5, max: 12, step: 0.1 },
			farSize: { value: 0.6, min: 0.1, max: 4, step: 0.1 },
